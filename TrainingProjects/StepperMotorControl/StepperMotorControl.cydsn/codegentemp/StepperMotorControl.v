// ======================================================================
// StepperMotorControl.v generated from TopDesign.cysch
// 09/28/2020 at 15:17
...
module top ;
	...
	wire [0:0] tmpOE__motorPin1_net;
	wire [0:0] tmpFB_0__motorPin1_net;
	wire [0:0] tmpIO_0__motorPin1_net;
	wire [0:0] tmpINTERRUPT_0__motorPin1_net;
	electrical [0:0] tmpSIOVREF__motorPin1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		motorPin1
		 (.oe(tmpOE__motorPin1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__motorPin1_net[0:0]}),
		  .io({tmpIO_0__motorPin1_net[0:0]}),
		  .siovref(tmpSIOVREF__motorPin1_net),
		  .interrupt({tmpINTERRUPT_0__motorPin1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__motorPin1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__motorPin2_net;
	wire [0:0] tmpFB_0__motorPin2_net;
	wire [0:0] tmpIO_0__motorPin2_net;
	wire [0:0] tmpINTERRUPT_0__motorPin2_net;
	electrical [0:0] tmpSIOVREF__motorPin2_net;

	cy_psoc3_pins_v1_10
		#(.id("6df761a3-3af1-41c0-9519-18079e800723"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		motorPin2
		 (.oe(tmpOE__motorPin2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__motorPin2_net[0:0]}),
		  .io({tmpIO_0__motorPin2_net[0:0]}),
		  .siovref(tmpSIOVREF__motorPin2_net),
		  .interrupt({tmpINTERRUPT_0__motorPin2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__motorPin2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__motorPin3_net;
	wire [0:0] tmpFB_0__motorPin3_net;
	wire [0:0] tmpIO_0__motorPin3_net;
	wire [0:0] tmpINTERRUPT_0__motorPin3_net;
	electrical [0:0] tmpSIOVREF__motorPin3_net;

	cy_psoc3_pins_v1_10
		#(.id("25888770-e5c9-41b8-a0a6-ce3b21b91a56"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		motorPin3
		 (.oe(tmpOE__motorPin3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__motorPin3_net[0:0]}),
		  .io({tmpIO_0__motorPin3_net[0:0]}),
		  .siovref(tmpSIOVREF__motorPin3_net),
		  .interrupt({tmpINTERRUPT_0__motorPin3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__motorPin3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__motorPin4_net;
	wire [0:0] tmpFB_0__motorPin4_net;
	wire [0:0] tmpIO_0__motorPin4_net;
	wire [0:0] tmpINTERRUPT_0__motorPin4_net;
	electrical [0:0] tmpSIOVREF__motorPin4_net;

	cy_psoc3_pins_v1_10
		#(.id("151f0808-ef7c-4343-a9e1-bdc7a5de98ea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		motorPin4
		 (.oe(tmpOE__motorPin4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__motorPin4_net[0:0]}),
		  .io({tmpIO_0__motorPin4_net[0:0]}),
		  .siovref(tmpSIOVREF__motorPin4_net),
		  .interrupt({tmpINTERRUPT_0__motorPin4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__motorPin4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
