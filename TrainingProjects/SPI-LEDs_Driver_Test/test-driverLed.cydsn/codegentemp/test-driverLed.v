...
module CapSense_CSD_P4_v2_60_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ead453e4-a06a-414c-8ed8-a32f71dd02e2/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ead453e4-a06a-414c-8ed8-a32f71dd02e2/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("56775c89-3d7d-4d83-8e85-b509dbc7a04e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("775c4bb6-ce00-47cf-bb97-30428f2bf5bd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b812bc13-ef80-4c59-9ad4-fdd3dacd11b7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__STR_net;
	wire [0:0] tmpFB_0__STR_net;
	wire [0:0] tmpIO_0__STR_net;
	wire [0:0] tmpINTERRUPT_0__STR_net;
	electrical [0:0] tmpSIOVREF__STR_net;
	...
	cy_psoc3_pins_v1_10
		...
		STR
		 (.oe(tmpOE__STR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__STR_net[0:0]}),
		  .io({tmpIO_0__STR_net[0:0]}),
		  .siovref(tmpSIOVREF__STR_net),
		  .interrupt({tmpINTERRUPT_0__STR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__STG_net;
	wire [0:0] tmpFB_0__STG_net;
	wire [0:0] tmpIO_0__STG_net;
	wire [0:0] tmpINTERRUPT_0__STG_net;
	electrical [0:0] tmpSIOVREF__STG_net;

	cy_psoc3_pins_v1_10
		#(.id("3b92b957-82ff-4ddd-a56e-fae44061ff72"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		STG
		 (.oe(tmpOE__STG_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__STG_net[0:0]}),
		  .io({tmpIO_0__STG_net[0:0]}),
		  .siovref(tmpSIOVREF__STG_net),
		  .interrupt({tmpINTERRUPT_0__STG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__STB_net;
	wire [0:0] tmpFB_0__STB_net;
	wire [0:0] tmpIO_0__STB_net;
	wire [0:0] tmpINTERRUPT_0__STB_net;
	electrical [0:0] tmpSIOVREF__STB_net;

	cy_psoc3_pins_v1_10
		#(.id("954ce2c3-e39b-4ad4-8ad5-ff91546aeabf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		STB
		 (.oe(tmpOE__STB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__STB_net[0:0]}),
		  .io({tmpIO_0__STB_net[0:0]}),
		  .siovref(tmpSIOVREF__STB_net),
		  .interrupt({tmpINTERRUPT_0__STB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
