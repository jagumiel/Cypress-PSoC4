...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT13), 0x00000011u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x800012BFu);

	/* CYDEV_CLK_DIVIDER_B01 Starting address: CYDEV_CLK_DIVIDER_B01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B01), 0x800001F3u);

	/* CYDEV_CLK_DIVIDER_C01 Starting address: CYDEV_CLK_DIVIDER_C01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C01), 0xC00001DFu);
...
void cyfitter_cfg(void)
{
...

	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F3252u, /* Base address: 0x400F3200 Count: 82 */
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x00993000u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT0_BASE), 0x00000028u);
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00031C00u);
	CY_SET_REG32((void *)(CYREG_PRT0_PC2), 0x00000020u);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x0000003Eu);
