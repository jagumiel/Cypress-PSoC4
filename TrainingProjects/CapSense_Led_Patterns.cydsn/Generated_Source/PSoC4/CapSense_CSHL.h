...
#define CapSense_TOTAL_BUTTONS_COUNT                 (5u)
...
#define CapSense_UNUSED_DEBOUNCE_COUNTER_INDEX       (5u)
...
#define CapSense_SENSOR_3_IS_ACTIVE             (0x03u)
#define CapSense_SENSOR_4_IS_ACTIVE             (0x04u)
#define CapSense_SENSOR_5_IS_ACTIVE             (0x05u)
