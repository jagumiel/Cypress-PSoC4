...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A00), 0x80000138u);

	/* CYDEV_CLK_DIVIDER_B00 Starting address: CYDEV_CLK_DIVIDER_B00 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B00), 0x800003BFu);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL4), 0x00000090u);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00C10000u);
	CY_SET_REG32((void *)(CYREG_PRT0_INTCFG), 0x00000C00u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x00000080u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x00400000u);
	CY_SET_REG32((void *)(CYREG_PRT2_INTCFG), 0x0000C000u);
	...
	CY_SET_REG32((void *)(CYREG_PRT4_PC), 0x00000030u);
