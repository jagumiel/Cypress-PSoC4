// ======================================================================
// Buttons-Leds-UART.v generated from TopDesign.cysch
// 07/21/2020 at 11:25
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=4, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_Right, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Right, CY_INSTANCE_SHORT_NAME=PWM_Right, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_Right, )
module PWM_v3_30_2 (
    reset,
    clock,
    tc,
...
module top ;
	...
	cy_psoc3_pins_v1_10
		...
		Button_Right
		 (.oe(tmpOE__Button_Right_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_Right_net[0:0]}),
	...
	cy_psoc3_pins_v1_10
		...
		Button_Left
		 (.oe(tmpOE__Button_Left_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_Left_net[0:0]}),
	...
	wire [0:0] tmpOE__Led_Right_net;
	wire [0:0] tmpFB_0__Led_Right_net;
	wire [0:0] tmpIO_0__Led_Right_net;
	wire [0:0] tmpINTERRUPT_0__Led_Right_net;
	electrical [0:0] tmpSIOVREF__Led_Right_net;

	cy_psoc3_pins_v1_10
		#(.id("65f176c1-ca72-4279-89d4-db8c4f9e4ac6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Led_Right
		 (.oe(tmpOE__Led_Right_net),
		  .y({Net_1043}),
		  .fb({tmpFB_0__Led_Right_net[0:0]}),
		  .io({tmpIO_0__Led_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__Led_Right_net),
		  .interrupt({tmpINTERRUPT_0__Led_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Led_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Led_Left_net;
	wire [0:0] tmpFB_0__Led_Left_net;
	wire [0:0] tmpIO_0__Led_Left_net;
	wire [0:0] tmpINTERRUPT_0__Led_Left_net;
	electrical [0:0] tmpSIOVREF__Led_Left_net;

	cy_psoc3_pins_v1_10
		#(.id("9b4ed688-0d7a-4a47-81e7-251c090d1b80"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Led_Left
		 (.oe(tmpOE__Led_Left_net),
		  .y({Net_934}),
		  .fb({tmpFB_0__Led_Left_net[0:0]}),
		  .io({tmpIO_0__Led_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__Led_Left_net),
		  .interrupt({tmpINTERRUPT_0__Led_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Led_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 SW_Right (
        .connect({
            Net_920,
            Net_1031
        })
    );
    defparam SW_Right.comp_name = "SwitchSPST_v1_0";
    defparam SW_Right.port_names = "T1, T2";
    defparam SW_Right.width = 2;


	cy_clock_v1_0
		#(.id("6ee52eac-f042-456c-84b3-c6d6b950e650"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("40000000000"),
		  .is_direct(0),
    ...
    cy_annotation_universal_v1_0 SW_Left (
        .connect({
            Net_922,
            Net_921
        })
    );
    defparam SW_Left.comp_name = "SwitchSPST_v1_0";
    defparam SW_Left.port_names = "T1, T2";
    defparam SW_Left.width = 2;
