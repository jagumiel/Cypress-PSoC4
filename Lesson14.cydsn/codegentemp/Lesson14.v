...
module top ;
    ...
    assign Net_38 = ~Net_31;

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_38)
    begin
        cy_tff_1 <= Net_39^Net_46;
    end
    ...
    begin
        cy_tff_2 <= Net_36^Net_78;
    end
    assign Net_78 = cy_tff_2;
    // -- TFF End --
    ...
    // -- TFF Start --
    reg  cy_tff_3;
    always @(posedge Net_78)
    begin
        cy_tff_3 <= Net_101^Net_59;
    end
    assign Net_59 = cy_tff_3;
    // -- TFF End --
