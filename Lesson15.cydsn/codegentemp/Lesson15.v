...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("bf89cddb-29bb-4d76-8d82-84095a987265"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("175b09c2-3cd9-40d0-823a-287542dd1786"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_186 or Net_152 or Net_166 or Net_170 or Net_185)
        begin
            case (Net_185[1:0])
                2'b00 :  tmp__mux_1_reg = Net_186;
                2'b01 :  tmp__mux_1_reg = Net_152;
                2'b10 :  tmp__mux_1_reg = Net_166;
                2'b11 :  tmp__mux_1_reg = Net_170;
            endcase
        end
        assign Net_171 = tmp__mux_1_reg;
    end
    // -- Mux end --
